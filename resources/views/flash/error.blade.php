@if (session('flash.type') === 'error')
    <div class="flex items-center justify-center px-10 sm:p-0">
        ...
        class="notification bg-red-500 p-3 rounded-full px-5 text-xs sm:text-sm text-white  inline-block mx-auto fixed bottom-0 mb-10 text-center shadow-lg z-[100]">
